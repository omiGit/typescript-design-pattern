...
var HTMLReportLayout_1 = require("../../abstract/ReportLayouts/HTMLReportLayout");
var lodash_1 = __importDefault(require("lodash"));
var HTMLTableLayout = /** @class */ (function (_super) {
    __extends(HTMLTableLayout, _super);
    function HTMLTableLayout(fileName, tableName, tableHeaderColumns) {
    ...
    HTMLTableLayout.prototype.getTr = function (data) {
        return "<tr>" + lodash_1.default.chain(data.split(","))
            .map(function (d) { return "<td>" + d + "</td>"; })
            .join("")
            .value() + "\n    </tr>";
    };
    HTMLTableLayout.prototype.getTh = function () {
        return "<tr>" + lodash_1.default.map(this.tableHeaderColumns, function (th) { return "<th>" + th + "</th>"; }).join("") + "</tr>";
    };
    HTMLTableLayout.prototype.getLayout = function (data) {
        var trData = lodash_1.default.chain(data).split("\n").value();
